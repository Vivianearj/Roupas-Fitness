...
<head>
    ...
    <meta charset="utf-8">    
    <link rel="stylesheet" type="text/css" href="css/casacos.css" media="all"/>
 </head> 
 <body>
 <div id="frete">
    ...
    <section id="produtos">
    <div class="produto">
            <a href=""><img src="img/casaco-bege.jpg"></a>
            <p id="nome"> COLETE NINA </p>
            <p> R$ 269.00 </p>
            <a href="" class='botaoComprar'>Comprar</a>
        </div>
        <div class="produto">
            <a href=""><img src="img/casaco-branco.jpg"></a>
            <p id="nome"> BLUSÃO MILENA </p>
            <p> R$ 169.00 </p>
            <a href="" class='botaoComprar'>Comprar</a>
        </div>
        <div class="produto">
            <a href=""><img src="img/casaco-preto.jpg"></a>
        ...
        <section id="produtos">
        <div class="produto">
            <a href=""><img src="img/casaco-preto2.jpg"></a>
            <p id="nome"> CASACO ELLEN </p>
            <p> R$ 269.00 </p>
            <a href="" class='botaoComprar'>Comprar</a>
        </div>
        <div class="produto">
            <a href=""><img src="img/casaco-rose.jpg"></a>
            <p id="nome"> COLETE VALENTINA </p>
            <p> R$ 169.00 </p>
            <a href="" class='botaoComprar'>Comprar</a>
        </div>
        <div class="produto">
            <a href=""><img src="img/casaco-rosa2.jpg"></a>
