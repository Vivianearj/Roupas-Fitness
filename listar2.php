...
<?php //recebe os valores e chama o nome das variaveis
$nome=$_GET['nome']; 
$email=$_GET['email'];
$cpf=$_GET['cpf'];
...
?>
 ...
 <body>
    ...
    <form action="AlterarProcessa.php" method="GET" >
        ...
        Nome Completo:<br>
        <input id="in1" type=text name=nome size="60" value="<?php echo $nome;?>"disabled><br><br>

        E-mail:<br>
        <input id="in2" type=text name=email size="60" value="<?php echo $email;?>"disabled><br><br>

        Cpf:<br>
        <input id="in3" type=number name=cpf size="60" value="<?php echo $cpf;?>"disabled><br><br>

        Telefone:<br>
        <input id="in4" type=number name=telefone size="60" value="<?php echo $telefone;?>"disabled><br><br>

        Endereço:<br>
        <input id="in5" type=text name=endereco size="60" maxlength="60" value="<?php echo $endereco;?>"disabled><br><br>

        Bairro:<br>
        <input id="in6" type=text name=bairro size="60" value="<?php echo $bairro;?>"disabled><br><br>

        Cep:<br>
        <input id="in7" type=number name=cep size="60" value="<?php echo $cep;?>"disabled><br><br>

        Estado:<br>
        <input id="in8" type=text name=estado size="60" value="<?php echo $estado;?>"disabled><br><br>

        Senha:<br>
        <input id="in9" type=password name=senha size="60" value="<?php echo $senha;?>"disabled><br><br>
    </form>
    </div>
    <footer>
        <section>
